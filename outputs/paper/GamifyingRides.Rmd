...
subtitle: "A report on the role of motivational affordance as a user experience design and its effects"
author: "Eden R. Barker"
thanks: 'Code and data supporting this analysis are available at: (https://github.com/edenbarker/GamifyingRides).'
date: "`r format(Sys.time(), '%d %B %Y')`"
abstract: "This report discusses the role of gamification in Peloton's exercise programs using user performance data gathered from the platform. The data is analyzed and visualized using the programming language R. The results suggest the occurrence of self-competition as a by-product of the program's gamification strategy experienced by users through motivational affordances to improve user performance and motivation. This demonstrates an intended design for user experience that can be beneficial to the user through increase physical activity and the company through user membership retention.\\par \\textbf{Keywords:} Bike+, Peloton, Gamification, Exercise, Indoor Cycling, Leaderboard, Motivation, User Experience, Self-Competition, Motivational Affordance."
...
Please note that the Shiny App Embedded (\ref(fig:ShinyApp)) is not created by the author, but rather was found through researching resources to build the report. The particular link was found in an online forum and was supposedly shared by the Shiny App creator under the name: *muddybanksofthemiss* [@RedditEntry] three years ago. The purpose of the preview is to show how sophisticated some of the Peloton users in terms of tracking and understanding their performance.

```{r ShinyApp, fig.cap="Shiny App Preview", echo = FALSE}
...
```{r GraphSet1, fig.cap="Figure 6. User Performance Summary from August 2020 to March 2022", echo = FALSE}
#Graph User 1 data from 2020-2022 to show overall performance summary
persona1 |> 
  ggplot(mapping = aes(x = total_output, y = length_minutes, fill = type)) +
   ...
   labs(x = "Total Output",
        ...
        color = "Class Type",
        title = "User 1 Performance Progress Summary from August 2020 to March 2022",
        caption = "Figure 5. User 1 Performance Summary from August 2020 to March 2022") +
  coord_flip() +
   facet_wrap(vars(year(workout)),
              scales = "free_x")

#Graph User 2 data from 2020-2022 to show overall performance summary
persona2 |> 
  ggplot(mapping = aes(x = total_output, y = length_minutes, fill = type)) +
   geom_bar(stat = "identity", position = position_dodge()) +
   labs(x = "Total Output",
...
persona1 |>
  ...
  labs(x = "Name of Coach",
       y = "Total Output",
       fill = "Type of Class",
       title = "User 1 Performance Overview Per Instructor and Class Type",
       caption = "Figure 7. User 1 Performance Summary Per Instructor and Class Type") +
  coord_flip() +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_color_brewer(palette = "Set1")

# Graph for User2 of class summary with data on coaches
persona2 |>
   ggplot (mapping = aes(x = instructor_name, group = total_output, fill = type)) +
  geom_dotplot(method = 'histodot', alpha = 0.3, binwidth = 1) +
  theme_minimal() +
  labs(x = "Name of Coach",
       y = "Total Output",
       fill = "Type of Class",
       title = "User 2 Performance Overview Per Instructor and Class Type",
       caption = "Figure 8. User 2 Performance Summary Per Instructor and Class Type") +
  coord_flip() +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_color_brewer(palette = "Set1")
...
#Figure3 Table is the overview of data created on the tibble
...
**Shiny App Link** - [Crushing It Link] (https://arraycgh.shinyapps.io/crushing_it/)
