...
user1df %>%
  ...
  fmt_number(
    columns = c(total_output, avg_watts, avg_cadence, avg_resistance),
    suffixing = TRUE
  )
```
# Figure 1. Shiny App Preview
...
# user1_data <- tibble(total_output = runif(49, c(43, 43), c(310,310)),
#                  date = c(seq(as.Date("2020-08-11"), as.Date("2020-08-18"), by = "days"),
#                            seq(as.Date("2021-04-12"), as.Date("2021-04-22"), by = "days"),
#                            seq(as.Date("2022-02-17"), as.Date("2022-03-18"), by = "days")),
#                  group = ifelse(lubridate::date(year) %in% c(2020,2021,2022), "2020-2021", "2021-2022"),
#                  date = lubridate::date(days))



# ggplot(user1_data, aes(x = dates, y = total_output, fill = group)) +
#     geom_bar(stat = 'identity', position = position_dodge()) +
#     scale_x_continuous(labels = paste0(1:12, "/2020 - 2021", "\n", 1:12, "/2021 - 2022"),
#                        breaks = 1:12) +
