...
persona1 <- read.csv("https://raw.githubusercontent.com/edenbarker/GamifyingRides/main/inputs/data/Persona1.csv?token=GHSAT0AAAAAABS7OT4NCDCQIXVHF46HTMYOYS3QWPA")

persona2 <- read.csv("https://raw.githubusercontent.com/edenbarker/GamifyingRides/main/inputs/data/Persona2.csv?token=GHSAT0AAAAAABS7OT4MOM24ACKZGPUJJWOIYS3QXBQ")

```

```{r Graph Set 1 Code, fig.cap="Figure 1. Total Output Summary per Type of Class", echo = FALSE}
# Graph for User1
# Graph User 1 faceted
persona1 |> 
  ggplot(mapping = aes(x = date, y = total_output, fill = type)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  labs(x = "Workout Dates",
       y = "Total Output",
       color = "Class Type",
       title = "User 1 Performance Data Per Length of Class in Minutes",
...
persona2 |> 
  ...
  labs(x = "Workout Dates",
       y = "Total Output",
       color = "Class Type",
       title = "User 2 Performance Data Per Length of Class in Minutes",
       caption = "Data source: Peloton") +
  coord_flip()+
