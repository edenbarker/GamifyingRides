...
Please not that the Shiny App Embedded (\ref(fig:ShinyApp)) is not created by the author, but rather was found through researching resources to build the report. The particular link was found in an online forum and was supposedly shared by the Shiny App creator under the name: *muddybanksofthemiss* [@Reddit2015] three years ago. The purpose of the preview is to show how sophisticated some of the Peloton users in terms of tracking and understanding their performance.
...
persona1 |> 
  ggplot(mapping = aes(x = total_output, y = length_minutes, fill = type)) +
   ...
   labs(x = "Total Output",
        ...
        color = "Class Type",
        title = "Figure 5: User 1 Performance Progress Summary from August 2020 to March 2022",
...
persona2 |> 
  ggplot(mapping = aes(x = total_output, y = length_minutes, fill = type)) +
   ...
   labs(x = "Total Output",
        y = "Length of Class in Minutes",
        color = "Class Type",
        title = "Figure 6: User 1 Performance Progress Summary from August 2020 to March 2022",
        caption = "Data Source: Peloton") +
  coord_flip() +
   facet_wrap(vars(year(workout)),
              scales = "free_x")
...
persona1 |>
  ...
  labs(x = "Name of Coach",
       y = "Total Output",
       fill = "Type of Class",
       title = "Figure 7: User 1 Performance Overview Per Instructor and Class Type",
       caption = "Data Source: Peloton") +
  coord_flip() +
...
persona2 |>
  ...
  labs(x = "Name of Coach",
       y = "Total Output",
       fill = "Type of Class",
       title = "Figure 8: User 2 Performance Overview Per Instructor and Class Type",
       caption = "Data Source: Peloton") +
  coord_flip() +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  scale_color_brewer(palette = "Set1")
